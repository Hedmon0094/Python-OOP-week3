...
class Student(Person):
    def __init__(self, *args, **kwargs):
        ...
        self.courses_enrolled = kwargs.get('courses_enrolled', [])

    def calculate_GPA(self):
        # Implement GPA calculation logic
        pass

#  implementations for Teacher, Course, and School classes

# Creating Objects
student1 = Student(name="Alice", age=19, address="123 Embu", contact_info="0756523951", student_id="S123", grade_level=10, GPA=3.8, courses_enrolled=["Math", "Science"])
teacher1 = Teacher(name="Dr. Smith", age=55, address="456 Oak", contact_info="0123857895", teacher_id="T456", subject="Math", experience=10, salary=50000)
course1 = Course(course_id="Math101", course_name="Algebra I", credits=3, prerequisites=[])

#Objects
print(student1)  # Directly print the object
